...
function loadExperiment() {
    ...
    if (!Detector.webgl) {
        ...
        b = "font-family: Monospace; margin: 0px; overflow: hidden;";
        divStyle = "position: fixed; left: 0px; top: 0px;";
        document.body.addEventListener("dragenter", PIEtableDragEnter, false);
        document.body.addEventListener("dragover", PIEtableDragOver, false);
        document.body.addEventListener("drop", PIEtableDrop, false);
        document.body.style = a;
        PIEscreenElem = document.createElement("div");
        PIEscreenElem.style.margin = "0px";
        PIEscreenElem.style.padding = "0px";
        document.body.appendChild(PIEscreenElem);
        PIEtoplineElem = document.createElement("div");
        PIEtoplineElem.style.backgroundColor = "#000000";
        PIEtoplineElem.style.color = "#fff";
        PIEtoplineElem.style.width = "100%";
        PIEtoplineElem.style.position = "absolute";
        PIEtoplineElem.style.left = "0";
        PIEtoplineElem.style.top = "0";
        document.body.appendChild(PIEtoplineElem);
        PIEsourceElem = document.createElement("span");
        PIEsourceElem.style = b;
        PIEtoplineElem.appendChild(PIEsourceElem);
        PIEdesignerElem = document.createElement("span");
        PIEdesignerElem.style = b;
        PIEtoplineElem.appendChild(PIEdesignerElem);
        PIEtitleElem = document.createElement("span");
        PIEtitleElem.style = b;
        PIEtoplineElem.appendChild(PIEtitleElem);
        PIEdeveloperElem = document.createElement("span");
        PIEdeveloperElem.style = b;
        PIEtoplineElem.appendChild(PIEdeveloperElem);
        PIEsourceElem.innerHTML = '<a href="http://www.ekshiksha.org.in" target="_blank" style="color:#FF5454;"><b><u>ekshiksha</u></b></a>';
        ...
        PIErenderer.domElement.addEventListener("click", PIEmouseClick, false);
        updateExperimentElements(0, 0);
...
function PIEaddSystemButtons() {
    ...
    PIEresetButton.innerHTML = '<img src="../PIE/images/ButtonRound.png" alt="reset" style="height: inherit; width: 60%;">';
    ...
    PIEpauseButton.innerHTML = '<img src="../PIE/images/ButtonPause.png" alt="pause" style="height: inherit; width: 60%;">';
    ...
    PIEresumeButton.innerHTML = '<img src="../PIE/images/ButtonPlay.png" alt="resume" style="height: inherit; width: 60%;">';
    ...
    PIEtoplineElem.appendChild(PIEspeedElem);
    ...
    PIEinfoButton.innerHTML = '<img src="../PIE/images/ButtonInfo.png" alt="info" style="height: inherit; width: 60%;">';
    ...
    PIEhelpButton.innerHTML = '<img src="../PIE/images/ButtonHelp.png" alt="help" style="height: inherit; width: 60%;">';
...
function PIEremoveDragElement(b) {
    ...
    c = false;
    for (a = 0;
        (c == false) && (a < PIEdragElements.length); a++) {
...
function PIEmouseMove(b) {
    ...
    if (PIEselectedDrag != null) {
        ...
        a = PIEraycaster.intersectObjects(PIEsceneElements);
        if (a.length > 0) {
...
function PIEsetClick(a, b) {
    a.click = b
}

function PIEresetClick(a, b) {
    a.click = null
}

function PIEmouseClick(c) {
    var b;
    var a;
    var d;
    c.defaultPrevented = true;
    PIEraycaster.setFromCamera(PIEmouseP, PIEcamera);
    b = PIEraycaster.intersectObjects(PIEsceneElements);
...
function PIEtableSetInputChange(a) {
    ...
    for (b = 0;
        (b < PIEtableRows[PIEcurrentTable].length); b++) {
        for (d = 0;
            (d < PIEtableData[PIEcurrentTable][b].length); d++) {
...
function PIEtableInputHandleEvent(d, g) {
    ...
    f = d.target;
    for (e = 0;
        (i == false) && (e < PIEtables.length); e++) {
        for (h = 0;
            (i == false) && (h < PIEtableRows[e].length); h++) {
            for (c = 0;
                (i == false) && (c < PIEtableData[e][h].length); c++) {
...
function PIEupdateTable() {
    ...
    for (c = 0;
        (c < PIEtableRows[PIEcurrentTable].length); c++) {
        a = PIEtableRows[PIEcurrentTable][c];
        PIEtables[PIEcurrentTable].appendChild(a);
        for (d = 0;
            (d < PIEtableData[PIEcurrentTable][c].length); d++) {
...
function PIEsetColumnInput(a, b, e) {
    ...
    var c;
    for (c = 0;
        (c < PIEtableRows[PIEcurrentTable].length) && (PIEtableRows[PIEcurrentTable][c] != null); c++) {
...
function PIEsetRowInput(e, a, d) {
    ...
    if ((PIEtableRows[PIEcurrentTable].length > e) && (PIEtableRows[PIEcurrentTable][e] != null)) {
        for (b = 0;
            (b < PIEtableData[PIEcurrentTable][e].length); b++) {
...
function PIEsetTableRowStyle(d, a, c) {
    ...
    if (d < PIEtableRows[PIEcurrentTable].length) {
        for (b = 0;
            (b < PIEtableData[PIEcurrentTable][d].length); b++) {
